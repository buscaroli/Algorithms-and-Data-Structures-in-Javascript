...
// The main index goes through the array from 0 tu its length - n.
// At every step, there is a inner loop that counts the sum of the next
// n elements of the array; at the end of the inner loop the sum is
// compared with the maximum value found so far (stored in the variable max)
// and if sum > max the maximum value is replaced.
// I have also inserted a console.log that prints the n elements responsible
...
console.log(`Array is: ${myArray} and num is: 14\n`)
